...
class Main {
    ...
    public long getGrndLevel() { return grnd_level; }
    public void setGrndLevel(long value) { this.grnd_level = value; }
    ...
    public void setSeaLevel(long value) { this.sea_level = value; }

    public double getFeelsLike() { return feels_like; }
    public void setFeelsLike(double value) { this.feels_like = value; }
